...
const TeacherSettings = () => {
    ...
    const [settings, setSettings] = useState({
        profile: {
            ...
            phone: "+998901234567",
            bio: "Professional web developer va ta'lim sohasida 5 yillik tajribaga ega",
    ...
    const fetchSettings = async () => {
        ...
        console.log("Fetching teacher settings...")
    }
    ...
    const handleDeleteAccount = () => {
        if (window.confirm("Hisobingizni o'chirishni xohlaysizmi? Bu amal qaytarib bo'lmaydi!")) {
            console.log("Deleting teacher account...")
    ...
    return (
        <div className="teacher-settings" data-theme={localStorage.getItem("theme") || "light"}>
                        ...
                        <div className="settings-section">
                            ...
                            <div className="notifications-section">
                                <div className="notification-category">
                                    ...
                                    <div className="notification-item">
                                        <div className="notification-info">
                                            <h4>Yangi o'quvchi</h4>
                                            <p>Kursingizga yangi o'quvchi qo'shilganda</p>
                                        </div>
                                        <label className="toggle-switch">
                                            <input
                                                type="checkbox"
                                                checked={settings.notifications.newStudent}
                                                onChange={(e) => handleInputChange('notifications', 'newStudent', e.target.checked)}
                                            />
                                            <span className="toggle-slider"></span>
                                        </label>
                                    </div>
                                ...
                                <div className="notification-category">
                                    ...
                                    <div className="notification-item">
                                        <div className="notification-info">
                                            <h4>Vazifa topshirilganda</h4>
                                            <p>O'quvchi vazifani topshirganda</p>
                                        </div>
                                        <label className="toggle-switch">
                                            <input
                                                type="checkbox"
                                                checked={settings.notifications.assignmentSubmission}
                                                onChange={(e) => handleInputChange('notifications', 'assignmentSubmission', e.target.checked)}
                                            />
                                            <span className="toggle-slider"></span>
                                        </label>
                                    </div>
                                ...
                                <div className="notification-category">
                                    ...
                                    <div className="notification-item">
                                        <div className="notification-info">
                                            <h4>Kurs xaridi</h4>
                                            <p>Kursingiz xarid qilinganda</p>
                                        </div>
                                        <label className="toggle-switch">
                                            <input
                                                type="checkbox"
                                                checked={settings.notifications.coursePurchase}
                                                onChange={(e) => handleInputChange('notifications', 'coursePurchase', e.target.checked)}
                                            />
                                            <span className="toggle-slider"></span>
                                        </label>
                                    </div>
